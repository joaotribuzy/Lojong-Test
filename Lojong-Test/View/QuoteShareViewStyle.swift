...
extension QuoteShareView: LojongCustomView{
    func style() {
    ...
    func autolayout() {
        self.top(0.0).left(0.0).right(0.0).bottom(0.0).height(365)
        
        self.sv(quoteBackgroundImageView.sv(quoteContent.sv(topFirstSeparatorLine,
                                                                        topSecondSeparatorLine,
                                                                        topAppLogo,
        ...
        quoteContent.top(18).right(0).bottom(18).left(0)
